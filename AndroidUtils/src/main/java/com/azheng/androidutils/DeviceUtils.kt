...
class DeviceUtils private constructor() {
    ...
    companion object {
        ...
        fun getAndroidID(): String {
            return try {
                val id = Settings.Secure.getString(Utils.getApplication().contentResolver, Settings.Secure.ANDROID_ID) ?: ""
        ...
        fun getMacAddress(): String {
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    val wifiManager = Utils.getApplicationContext().getSystemService(Context.WIFI_SERVICE) as WifiManager
                    val wifiInfo = wifiManager.connectionInfo
                    if (wifiInfo != null) {
                        val macAddress = wifiInfo.macAddress
                        // 排除随机生成的 MAC 地址
                        if (!TextUtils.isEmpty(macAddress) && !"02:00:00:00:00:00".equals(macAddress, ignoreCase = true)) {
                            return macAddress
                        }
                    }
                }
        ...
        val isEmulator: Boolean
            get() {
                ...
                var operatorName = ""
                try {
                    val tm = Utils.getApplication().getSystemService(Context.TELEPHONY_SERVICE) as android.telephony.TelephonyManager
